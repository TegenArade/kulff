...
public class MainActivity extends AppCompatActivity implements FingerprintActivityInterface {
    ...
    private class PurchaseButtonClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (initCipher(mCipher, mKeyName)) {
                ...
                fragment.setFingerprintActivityInterface(MainActivity.this);
                //fragment.setSharedPreferences(mSharedPreferences);
